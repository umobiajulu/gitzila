            ...
            <div class="row no-gutters">
                <div class="col-lg-12 card-body">
                    ...
                    <p class="text-muted">
                     ...
                     2. If there are files or folders that are not part of your git repo but crucial in your app, you will have to ignore them manually using ".gitignore" file else our system will unlink them while trying to configure the app
                 </p> 
                </div>
            </div>
        </div>
